...
def prepare_run(name,configs,deals,purpose,reference=None):
    ...
    sources=['training/progressive_planner.py','training/progressive_torch_env.py','training/progressive_belief.py','training/progressive_campaign.py','training/explore_small_strategies.py',
    ...
    for candidate,params in configs.items():
        ...
        if params.get('belief_oversample'):dependencies.append(snapshot/'training/progressive_belief.py')
