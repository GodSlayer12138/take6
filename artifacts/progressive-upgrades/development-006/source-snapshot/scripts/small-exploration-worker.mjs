import { chooseSmallCard } from './small-strategy-runtime.mjs'
...
function act({ id, observation }) {
  ...
  if (observation.hand.length === 1) card = observation.hand[0]
    ...
    if (model.format === 'ntw-small-player-v1') card = chooseSmallCard(observation, model).card
    else if (model.format === 'ntw-neural-v1') card = chooseNeuralCard(observation, model).card
