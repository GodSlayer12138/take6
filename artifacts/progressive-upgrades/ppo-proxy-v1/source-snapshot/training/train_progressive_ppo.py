"""On-policy win optimization against the learned 3/4-player opponent league.
...
if __name__=='__main__':
    parser=argparse.ArgumentParser();parser.add_argument('--output',default='ppo-proxy-v1');main(parser.parse_args())
