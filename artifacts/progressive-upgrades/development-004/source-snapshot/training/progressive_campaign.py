...
def prepare_run(name,configs,deals,purpose,reference=None):
    ...
    sources=['training/progressive_planner.py','training/progressive_torch_env.py','training/progressive_belief.py',
        'training/progressive_inference_service.py','training/run_progressive_with_service.py','training/progressive_campaign.py','training/explore_small_strategies.py',
