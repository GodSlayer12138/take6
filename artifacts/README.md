...
| 目录 | 角色 |
|---|---|
| `progressive-upgrades/` | 当前推演版、必要的冻结代码、接受状态和保留的结果摘要 |
| `small-player-exploration/` | 双人版、基线与对手索引、最终结果摘要 |
| `small-player-iterations/` | 早期迭代模型；其中 V4 仍是推演版依赖 |
| `models/` | 通用版、推演版及保留基线所需的权重与配置 |
